...
if (not st.session_state['data_L_loaded']) or (not st.session_state['data_R_loaded']):
    st.write("Data sets have not been loaded completely. Go to page #BLAH# to load the datasets.")
else:
